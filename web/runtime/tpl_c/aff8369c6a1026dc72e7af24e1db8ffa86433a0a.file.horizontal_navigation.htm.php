<?php /* Smarty version Smarty-3.1.13, created on 2013-10-11 17:22:07
         compiled from "/home/eric/share/pocket/cms/protected/views/layouts/horizontal_navigation.htm" */ ?>
<?php /*%%SmartyHeaderCode:4689690995257c33f5dfc13-03642093%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aff8369c6a1026dc72e7af24e1db8ffa86433a0a' => 
    array (
      0 => '/home/eric/share/pocket/cms/protected/views/layouts/horizontal_navigation.htm',
      1 => 1381467216,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4689690995257c33f5dfc13-03642093',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5257c33f5e8484_94656443',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5257c33f5e8484_94656443')) {function content_5257c33f5e8484_94656443($_smarty_tpl) {?>				<div class="navbar navbar-fixed-top">
...
/img/user_avatar.png" alt="" class="user_avatar" />Johny Smith <b class="caret"></b></a>
							...
							<ul class="nav" id="mobile-nav">
								<li class="dropdown">
									<a data-toggle="dropdown" class="dropdown-toggle" href="#" style="font-size:15px;font-weight:700;font-family:微软雅黑;"><i class="icon-list-alt icon-white"></i> CMS <!-- <b class="caret"></b> --></a>
								...
								<li class="dropdown">
									<a data-toggle="dropdown" class="dropdown-toggle" href="#" style="font-size:15px;font-weight:700;font-family:微软雅黑;"><i class="icon-th icon-white"></i> BMS <!--  <b class="caret"></b> --></a>
									<!-- 
									<ul class="dropdown-menu">
								...
								<li class="dropdown">
									<a class="dropdown-toggle" href="/admin/user/" style="font-size:15px;font-weight:700;font-family:微软雅黑;" ><i class="icon-file icon-white"></i> 管理  <!-- <b class="caret"></b> --></a>
									<!-- 
									<ul class="dropdown-menu">
								...
								<li class="dropdown">
									<a data-toggle="dropdown" class="dropdown-toggle"  href="#" style="font-size:15px;font-weight:700;font-family:微软雅黑;"><i class="icon-wrench icon-white"></i> 工具 <!--  <b class="caret"></b> --></a>
