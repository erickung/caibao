...
abstract class CDbTestCase extends CTestCase
{
	...
	public function getTestData(CActiveRecord $ar)
	{
		$name = $ar->getTableSchema()->name;
		$file = Yii::getPathOfAlias('application.tests.fixtures') . '/' . $name . '.php';
	...
	{
		if (!interface_exists('CMSInterface'))
			require APP_PROTECT . 'components/CMSInterface.php';
		/*
		parent::setUp();
